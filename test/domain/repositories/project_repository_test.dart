...
void main() {
  ...
  group('ProjectRepository', () {
    ...
    test('should get project by id', () async {
      when(mockProjectRepository.getProjectById(1)).thenAnswer((_) async => testProject);
      final result = await mockProjectRepository.getProjectById(1);
      expect(result, testProject);
    });

    test('should create project', () async {
      when(mockProjectRepository.createProject(testProject)).thenAnswer((_) async => {});
    ...
    test('should update project', () async {
      when(mockProjectRepository.updateProject(testProject)).thenAnswer((_) async => {});
    ...
    test('should soft delete project', () async {
      when(mockProjectRepository.softDeleteProject(1)).thenAnswer((_) async => {});
    ...
    test('should get unsynced projects', () async {
      when(mockProjectRepository.getUnsyncedProjects()).thenAnswer((_) async => [testProject]);
      final result = await mockProjectRepository.getUnsyncedProjects();
      expect(result, [testProject]);
    });

    test('should mark project as synced', () async {
      when(mockProjectRepository.markProjectAsSynced(1)).thenAnswer((_) async => {});
