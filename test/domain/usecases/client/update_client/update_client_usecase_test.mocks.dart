...
// in lapor_kerja/test/domain/usecases/client/update_client/update_client_usecase_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockClientRepositoryForUpdate extends _i1.Mock
    implements _i2.ClientRepository {
  MockClientRepositoryForUpdate() {
    _i1.throwOnMissingStub(this);
  }
