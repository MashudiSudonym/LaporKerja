...
// in lapor_kerja/test/domain/usecases/income/delete_income/delete_income_usecase_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockIncomeRepositoryForDelete extends _i1.Mock
    implements _i2.IncomeRepository {
  MockIncomeRepositoryForDelete() {
    _i1.throwOnMissingStub(this);
  }
